...
// Function to handle displaying the correct price field
...
// home page dropdown selection javascript
...
bedroomItems.forEach(item => {
    item.addEventListener('click', function(event) {
        ...
        bedroomButton.textContent = selectedBedroom + (selectedBedroom === "1" ? " Bedroom" : " Bedrooms");
    });
});
...
// home page trend home slider javascript
